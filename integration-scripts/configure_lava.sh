...
echo "{% set poweron_command = 'pduclient --daemon localhost --hostname 127.0.0.1 --port 4 --command on' %}" >> mybbb.dat
echo "{% set poweroff_command = 'pduclient --daemon localhost --hostname 127.0.0.1 --port 4 --command off' %}" >> mybbb.dat
echo "{% set reboot_command = 'pduclient --daemon localhost --hostname 127.0.0.1 --port 4 --command reboot' %}" >> mybbb.dat
